...
if ENV == 'env':
    ...
    # Production
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://xthxdfdvqyuemp:21d915792443d112491be6df34db2960868a5bb14b842d9b93eee4b4e2d2fc9f@ec2-54-160-18-230.compute-1.amazonaws.com:5432/deg2a3totr186l'

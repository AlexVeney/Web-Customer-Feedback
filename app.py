...
if ENV == 'env':
    ...
    string = "L4Y>6K5(Zqc2!Y26"
    mod_string = 'postgresql://postgres:'+string+'@localhost/lexus'
    app.config['SQLALCHEMY_DATABASE_URI'] = mod_string
else:
    # Production
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://ozzyreyerqngwa:e8dc6ca72e2868e46fbfedf1febc4309d4bac2e21e8f7b425d37e0c2541d8b88@ec2-54-160-18-230.compute-1.amazonaws.com:5432/deg2a3totr186l'
